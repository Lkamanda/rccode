...
time.sleep(4)
driver.find_element_by_xpath("//android.widget.LinearLayout/android.widget.LinearLayout[ce1]/android.widget.EditText").send_keys('1599200510')
driver.implicitly_wait(10)
driver.find_element_by_xpath("//android.widget.FrameLayout[@content-desc='当前所在页面,登录微信']/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.View/android.widget.FrameLayout[2]/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.EditText").send_keys("5211314zxy.")
driver.implicitly_wait(10)
